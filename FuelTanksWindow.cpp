...
FuelTanksWindow::FuelTanksWindow(ResearchesWindow* mainWin){
    ...
    Picture tank1(100, 100, 96, 96, "C:/Users/Zenbook/Desktop/Graphproject/Pictures/Топливный1.png");
    ...
    Picture tank2(100, 196, 96, 96, "C:/Users/Zenbook/Desktop/Graphproject/Pictures/Топливный2.png");
...
void FuelTanksWindow::updateButtonsState(){
    ...
    if (Rockets_parts.at("FuelTank1").getIsUnlocked()) {
        ...
        unlock_tank1->setColor(FL_BACKGROUND_COLOR); // Обычный цвет
        unlock_tank1->getButton()->copy_label("Исследовано ✓");
    } else if (Player.getMoney() >= Rockets_parts.at("FuelTank1").getPrice()) {
    ...
    if (Rockets_parts.at("FuelTank2").getIsUnlocked()) {
        ...
        unlock_tank2->setColor(FL_BACKGROUND_COLOR); // Обычный цвет
        unlock_tank2->getButton()->copy_label("Исследовано ✓");
    } else if (Player.getMoney() >= Rockets_parts.at("FuelTank2").getPrice() && Moon.getPercentColonization()!=0) {
